      ...
      userSignUp = (emailId,password,confirmPassword) => {
        ...
        .then(()=>{
          db.collection("users").add({
            ...
            return Alert.alert("Successfully Created An Account"," ", [{text:"Ok", onPress:() => {this.setState({isModalVisible:false})} }])
        })
        .catch((error) => {
            return Alert.alert(error)
        })
        ...
        return(
          <Modal animationType={"fade"} transparent={true} visible={this.state.isModalVisible}>
            <View style = {styles.modalContainer}>
              ...
              <View>
                <TouchableOpacity style={styles.cancelButton} onPress={() => {this.setState({isModalVisible:false})}}><Text style={{color:"#ff5722"}}>Cancel</Text></TouchableOpacity>
              </View>
